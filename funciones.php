...
$Fec_Ini_Sem1 = strtotime("2023-03-13");
$Fec_Fin_Sem1 = strtotime("2023-07-22");

// Inicio y término 1ra nota de cátedra del 1er semestre
$f_ini_nc1_sem1  = strtotime("2023-04-17");
$f_fin_nc1_sem1  = strtotime("2023-04-22");

// Inicio y término Solemnes I 1er semestre
$f_ini_sol1_sem1  = strtotime("2023-05-08");
$f_fin_sol1_sem1  = strtotime("2023-05-20");

// Inicio y término Solemnes II 1er semestre
$f_ini_sol2_sem1  = strtotime("2023-06-27");
$f_fin_sol2_sem1  = strtotime("2023-07-08");

// Inicio y término Recuperativas 1er semestre
$f_ini_recup_sem1 = strtotime("2023-07-17");
$f_fin_recup_sem1 = strtotime("2023-07-22");

// Inicio y término 2do semestre
$Fec_Ini_Sem2 = strtotime("2023-08-07");
$Fec_Fin_Sem2 = strtotime("2023-12-17");

// Inicio y término Solemnes I 2do semestre
$f_ini_sol1_sem2  = strtotime("2023-10-02");
$f_fin_sol1_sem2  = strtotime("2023-10-16");

// Inicio y término Solemnes II 2do semestre
$f_ini_sol2_sem2  = strtotime("2023-11-20");
$f_fin_sol2_sem2  = strtotime("2023-12-02");

// Inicio y término Recuperativas 2do semestre
$f_ini_recup_sem2 = strtotime("2023-12-11");
$f_fin_recup_sem2 = strtotime("2023-12-16");


$FEC_INI_TOMA_RAMOS = strtotime("2023-03-01");
$FEC_FIN_TOMA_RAMOS = strtotime("2023-04-16");

// Fechas de Postulación a Beca UMC (afecta sólo a estudiantes)
$FEC_INI_POSTBECAUMC = strtotime("2022-10-03");
$FEC_FIN_POSTBECAUMC = strtotime("2023-03-31");

// Fechas de Solicitudes (Periodo en que los alumnos pueden hacerlas)
$FEC_INI_SOLICITUDES = strtotime("2021-03-01");
$FEC_FIN_SOLICITUDES = strtotime("2024-01-26");

$SEMESTRE_InsAsig = 1;
$ANO_InsAsig = 2023;

$ANO_MATRICULA = 2023;
$SEMESTRE_MATRICULA = 2;
