...
<div id="menu">
  <ul>
    ...
    <?php if (!(time() > $FEC_FIN_TOMA_RAMOS && $FEC_INI_TOMA_RAMOS < time()) && ($_SESSION['semestre_cohorte']."-".$_SESSION['cohorte'] <> $SEMESTRE."-".$ANO)) { ?><li><a href="principal.php?modulo=inscripcion_asignaturas">Toma de Ramos</a></li><?php } ?>
