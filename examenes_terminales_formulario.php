...
<?php if ($modulo == "examenes_terminales_editar") { ?>
  <tr>
    ...
    <td class='celdaValorAttr'><?php echo($_REQUEST['estado'] . " <i>desde el " . $_REQUEST['estado_fecha'] . "</i>"); ?></td>
  </tr>
<?php } ?>
  <tr>
  ...
  <tr>
    ...
    <td class='celdaValorAttr'>      
      <input type="date" id="fecha" name="fecha" min="<?php echo($fecha); ?>" class="boton" value="<?php echo($_REQUEST['fecha']); ?>" required>
