...
if(filter_input(INPUT_POST, 'btnGrabaPaso1')){
    // Propiedades del archivo
  echo"viene desde Grabar paso 1";
}
...
<form name="formularioPaso1" action="principal.php?modulo=MatriculaOnline/IngresoMatriculaOnlineAlumno" method="POST" target='_self'>
  <table cellpadding="4" border="0" cellspacing="4" width="auto">
    <tr>
      <td align="center" class="celdaFiltro" width="100%"><b>MATRICULATE ONLINE.</b> <br>
      </td>
    </tr>
    <br> 
    <tr>
      <td align="center" class="celdaFiltro" width="100%"><b>Paso 1 Datos de Identidad</b> <br>
      </td>
    </tr>
    <tr>
      <td class="celdaFiltro">
        Tipo de documento de Identidad: <br>
        <select class="filtro" name="semestre_cohorte" style="visibility: visible;">
          <option value="0"></option>
            <option value="carnet" class="1">Carnet</option>
            <option value="pasaporte" class="2">Pasaporte</option>
        </select>
      </td>
    </tr>
    <tr>
      <td class="celdaFiltro">
        N° de documento:<br>
        <input type="text" name="texto_buscar" align="right" value="<?php echo($texto_buscar); ?>" size="30" id="texto_buscar" class='boton'>
      </td>
    </tr>
    <br>
    <tr>
    ...
    <tr>
      <td class="celdaFiltro">
        Apellido materno:<br>
        <input type="text" name="texto_amaterno" align="right" value="<?php echo($texto_buscar); ?>" size="30" id="texto_amaterno" class='boton'>
      </td>
    </tr>
    <br>
    <tr>
      <td class="celdaFiltro">
        ...
        <input type="text" name="texto_email" align="right" value="<?php echo($texto_buscar); ?>" size="30" id="texto_email" class='boton'>
      </td>
    </tr>
    <br>
    <tr>
      <td class="celdaFiltro">
        Teléfono celular:<br>
        <input type="text" name="texto_celular" align="right" value="<?php echo($texto_buscar); ?>" size="30" id="texto_celular" class='boton'>
      </td>
    </tr>
    <br>
    <tr>
      <td class="celdaFiltro">
        ...
        <input type="date" name="texto_buscar" align="right" value="<?php echo($texto_buscar); ?>" size="30" id="texto_buscar" class='boton'>
      </td>
    </tr>
    <br>
    <tr>
      <td class="celdaFiltro">
        ...
        <select class="filtro" name="semestre_cohorte" style="visibility: visible;">
          <option value="0"></option>
            <option value="soltero" class="1">Soltero</option>
            <option value="casado" class="2">Casado</option>
        </select>
      </td>
    </tr>
    <br>
    <tr>
      <td class="celdaFiltro">
        ...
        <select class="filtro" name="semestre_cohorte" style="visibility: visible;">
          <option value="0"></option>
            <option value="hombre" class="1">Hombre</option>
            <option value="mujer" class="2">Mujer</option>
        </select>
      </td>
    </tr>
    <br>
    ...
    <tr>
      <td class="celdaFiltro">
        Dirección:<br>
        <input type="text" name="texto_direccion" align="right" value="<?php echo($texto_buscar); ?>" size="30" id="texto_direccion" class='boton'>
      </td>
    </tr>
    <tr>
     <td>
...
<form name="formularioPaso2" action="principal.php?modulo=MatriculaOnline/IngresoMatriculaOnlineAlumno" method="POST" target='_self'>
  <table cellpadding="4" border="0" cellspacing="4" width="auto">
    <tr>
      <td align="center" class="celdaFiltro" width="100%"><b>Paso 2 Vía de Admisión</b> <br>
      </td>
    </tr>
    ...
    <tr>
      <td class="celdaFiltro">
        ...
        <select class="filtro" name="semestre_cohorte" style="visibility: visible;">
          <option value="0"></option>
            <option value="1anio" class="1">Primer año</option>
            <option value="convalida" class="2">Convalidante</option>
        </select>
      </td>
    </tr>
    <tr>
     <td>
      <input type="submit" name="btnGrabaPaso2" value="Guardar Paso 2" /> 
     </td>
    </tr>
  </table>
</form>

<form name="formularioPaso3" action="principal.php?modulo=MatriculaOnline/IngresoMatriculaOnlineAlumno" method="POST" target='_self'>
  <table cellpadding="4" border="0" cellspacing="4" width="auto">
    <tr>
      <td align="center" class="celdaFiltro" width="100%"><b>Paso 3 Escoge Carrera o Programa</b> <br>
      </td>
    </tr>
    ...
    <tr>
     <td>
      <input type="submit" name="btnGrabaPaso3" value="Guardar Paso 3" /> 
     </td>
    </tr>
  </table>
</form>
