COPY (SELECT 'R' AS tipo_docto_ident,
                ...
                WHERE true   AND (lower(a.nombres||' '||a.apellidos) ~* '[oó]sc[aá]r' OR  a.rut ~* '[oó]sc[aá]r' OR  lower(a.email) ~* '[oó]sc[aá]r' OR  text(a.id) ~* '[oó]sc[aá]r' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'r[oó]j[aá]s' OR  a.rut ~* 'r[oó]j[aá]s' OR  lower(a.email) ~* 'r[oó]j[aá]s' OR  text(a.id) ~* 'r[oó]j[aá]s' ) AND (lower(a.nombres||' '||a.apellidos) ~* 'c[aá]rr[aá]sc[oó]' OR  a.rut ~* 'c[aá]rr[aá]sc[oó]' OR  lower(a.email) ~* 'c[aá]rr[aá]sc[oó]' OR  text(a.id) ~* 'c[aá]rr[aá]sc[oó]' )  AND a.carrera_actual IN (59,57,27,28,33,54,56,31,58,60,55,30,32,29,76,79,82,81,83,78,80,38,115,114,77,125)  
