...
$CARRERAS = consulta_sql("SELECT id,nombre,CASE WHEN activa THEN 'Vigentes' ELSE 'No Vigentes' END AS grupo FROM carreras WHERE regimen='$regimen' ORDER BY activa DESC,nombre");
