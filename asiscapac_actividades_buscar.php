...
--CONVOCADOS
(select count(*) 
	from asiscapac_actividades_obligatorias_funcionarios b ,
		 usuarios u
	where b.ano = $ano and b.id_asiscapac_actividades = a.id and b.convocado = 't'
		and  b.id_usuario = u.id
		and coalesce(u.fecha_desvinculacion::date, (SELECT fecha_inicio::date FROM asiscapac_actividades WHERE id = a.id) ) >= (SELECT fecha_inicio::date FROM asiscapac_actividades WHERE id = a.id) 
) as universo_convocados,

--PRESENTES
(select count(*) 
	from asiscapac_actividades_obligatorias_funcionarios b,
		 usuarios u
	where b.ano = $ano and b.id_asiscapac_actividades = a.id 
		and b.convocado = 't' and b.id_asiscapac_actividades_funcionarios_check = 2
		and  b.id_usuario = u.id
		and coalesce(u.fecha_desvinculacion::date, (SELECT fecha_inicio::date FROM asiscapac_actividades WHERE id = a.id) ) >= (SELECT fecha_inicio::date FROM asiscapac_actividades WHERE id = a.id)
 --PRESENTES
...
( select count(*) 
	from asiscapac_actividades_obligatorias_funcionarios b,
		 usuarios u
	where b.ano = $ano and b.id_asiscapac_actividades = a.id 
		and b.convocado = 't' and b.id_asiscapac_actividades_funcionarios_check = 3
		and b.id_usuario = u.id
		and coalesce(u.fecha_desvinculacion::date, (SELECT fecha_inicio::date FROM asiscapac_actividades WHERE id = a.id) ) >= (SELECT fecha_inicio::date FROM asiscapac_actividades WHERE id = a.id) 
 --JUSTIFICADOS
...
select count(*) 
	from asiscapac_actividades_obligatorias_funcionarios b ,
		 usuarios u
	where b.ano = $ano and b.id_asiscapac_actividades = a.id and b.convocado = 't' and b.id_asiscapac_actividades_funcionarios_check = 4 
		and  b.id_usuario = u.id
		and coalesce(u.fecha_desvinculacion::date, (SELECT fecha_inicio::date FROM asiscapac_actividades WHERE id = a.id) ) >= (SELECT fecha_inicio::date FROM asiscapac_actividades WHERE id = a.id) 
 --LICENCIA MEDICA
...
select count(*) 
	from asiscapac_actividades_obligatorias_funcionarios b,
		 usuarios u
	where b.ano = $ano and b.id_asiscapac_actividades = a.id and b.convocado = 't' and b.id_asiscapac_actividades_funcionarios_check = 5
			 and  b.id_usuario = u.id
		and coalesce(u.fecha_desvinculacion::date, (SELECT fecha_inicio::date FROM asiscapac_actividades WHERE id = a.id) ) >= (SELECT fecha_inicio::date FROM asiscapac_actividades WHERE id = a.id) 
 --INASISTENTE
