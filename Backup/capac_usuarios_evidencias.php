...
<th class='tituloTabla' style="display:none;">Estado</th> 
<th class='tituloTabla' style="display:none;" <?php echo($esconder); ?>>Convocatoria <br> <input type='checkbox' id='id_todos_check' name='id_todos_check' onclick=marcarTodos()>Todos</th> 
<th class='tituloTabla' style="display:none;">Convocado</th> 
<th class='tituloTabla' style="display:none;">Minutos <br> en reunión</th> 
<th class='tituloTabla' style="display:none;">Observación</th> 
